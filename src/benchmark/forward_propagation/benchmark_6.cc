...
void program_body( const unsigned int num_iterations )
{
  ...
  auto nn
    = make_unique<Network<batch_size, input_size, 1024, 1024, 1024, 1024, 1024, 1024, 1024, 1024, 1024, 1024, 1>>();
  ...
  // cout << " per iteration\n";
  cout << int( ( end - start ) / float( num_iterations ) );
  cout << " ns per iteration\n";
}

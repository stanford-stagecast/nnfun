// Experimental TINY neural network to figure out how to manually change weights
...
{
  auto nn = make_unique<
    NeuralNetwork<float, num_layers, batch_size, input_size, output_size, 1, 4, 1>>();
  ...
  string printed_weights_file = "/home/gbishko/nnfun/src/frontend/output_weights.txt";

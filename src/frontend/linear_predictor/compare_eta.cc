...
int program_body( double lr_1, double lr_2, float epsilon )
{
  ...
  for ( auto i = 0; i < 20000; i++ ) {
    ...
    auto temp_learning_rate_one = lr_1 * learning_rate;
    auto temp_learning_rate_two = lr_2 * learning_rate;
    ...
    if ( ( nn->layer0.weights()( 0 ) <= 3 + epsilon ) && ( nn->layer0.weights()( 0 ) >= 3 - epsilon ) ) {
      if ( ( nn->layer0.biases()( 0 ) <= 1 + epsilon ) && ( nn->layer0.biases()( 0 ) >= 1 - epsilon ) ) {
        return i;
      }
    }
...
int main( int argc, char*[] )
{
  try {
    ...
    for ( auto i = 0; i < 100; i++ ) {
      rounds_1 += program_body( 4.0 / 3, 2.0 / 3, pow( 10, -7 ) );
      rounds_2 += program_body( 2.0, 1.0, pow( 10, -7 ) );
    }
    cout << "4/3, 2/3: \t" << rounds_1 / 100 << endl;
    cout << "2, 1: \t\t" << rounds_2 / 100 << endl;
